...
BONUS_SRCS = $(BONUS_SRCS_FOLDER)parsing/parsing_utils_bonus.c \
	$(BONUS_SRCS_FOLDER)parsing/parsing_bonus.c \
	$(BONUS_SRCS_FOLDER)pipex_struct/cmd_lst_bonus.c \
	$(BONUS_SRCS_FOLDER)pipex_struct/pipex_struct_bonus.c \
	$(BONUS_SRCS_FOLDER)pipex_bonus.c 
